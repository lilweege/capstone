...
\begin{itemize}
    ...
    \item Let \( Z \) represent the set of .zip files containing system outputs.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{FR-9}: The system shall package outputs \( R \) into \( z \in Z \) and email \( z \) to a specified address.
    \item \textbf{FR-10}: The system shall visualize \( z \in Z \) uploaded by a user \( u \in U \) on the user interface.
\end{itemize}
