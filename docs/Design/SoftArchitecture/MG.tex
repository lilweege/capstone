...
\begin{description}
\item[Secrets:] The format and structure of the input data for the model.
\item[Services:] Converts the input data files into the data structure
used by the NLP model module.
...
\begin{description}
\item[Secrets:] The logic to intake report files as well as display information 
...
\begin{description}
\item[Secrets:] The logic for displaying outputs of
the model on front end.
...
\begin{description}
\item[Secrets:] The logic for creating and emailing report files
from an analysis.
\item[Services:] Creates and emails a report from plagarism run.
\item[Implemented By:] \progname{}
\item[Type of Module:] Library Component
\end{description}
